...
def cont(type_method):
    ...
    # max_row = 250
    # i = 0
    # with open('pos_test.txt', 'r', encoding='utf-8') as pos:
    #     for content in pos:
    #         i += 1
    #         if i > max_row:
    #             break
    ...
    # i = 0
    # with open('neg_test.txt', 'r', encoding='utf-8') as neg:
    #     for content in neg:
    #         i += 1
    #         if i > max_row:
    #             break
